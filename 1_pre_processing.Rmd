...
diff <- setdiff(EstMB_metadata$skood, EstMB_abundances$skood)
EstMB_metadata <- EstMB_metadata[!EstMB_metadata$skood %in% diff,]
...
write.table(EstMB_abundances_10,"./data/processed/EstMB_abundances_10.txt", row.names = FALSE)

EstMB_abundances_50 <- taxa.filter(EstMB_abundances, percent.filter = 0.50, relabund.filter = 0.001)
write.table(EstMB_abundances_50,"./data/processed/EstMB_abundances_50.txt", row.names = FALSE)
```
...
write.table(EstMB_abundances_10_pc,"./data/processed/EstMB_abundances_10_pc.txt", row.names = FALSE)
...
write.table(EstMB_abundances_50_pc,"./data/processed/EstMB_abundances_50_pc.txt", row.names = FALSE)
```
...
write.table(PCOS_abundances_10,"./data/processed/PCOS_abundances_10.txt", row.names = FALSE)

PCOS_abundances_50 <- taxa.filter(PCOS_abundances, percent.filter = 0.50, relabund.filter = 0.001)
write.table(PCOS_abundances_50,"./data/processed/PCOS_abundances_50.txt", row.names = FALSE)
```
...
write.table(PCOS_abundances_10_pc,"./data/processed/PCOS_abundances_10_pc.txt", row.names = FALSE)
...
write.table(PCOS_abundances_50_pc,"./data/processed/PCOS_abundances_50_pc.txt", row.names = FALSE)
```
...
CRC_metadata_holdout <- CRC_metadata %>% 
...
write.table(CRC_metadata_holdout,"./data/processed/CRC_metadata_holdout.txt", row.names = FALSE)
...
# create abundance table of holdout data
diff <- setdiff(CRC_abundances$SampleID, CRC_metadata_holdout$SampleID)
CRC_abundances_holdout <- CRC_abundances[!CRC_abundances$SampleID %in% diff,]

write.table(CRC_abundances_holdout,"./data/processed/CRC_abundances_holdout.txt", row.names = FALSE)
...
write.table(CRC_abundances_10,"./data/processed/CRC_abundances_10.txt", row.names = FALSE)

CRC_abundances_50 <- taxa.filter(CRC_abundances, percent.filter = 0.50, relabund.filter = 0.001)
write.table(CRC_abundances_50,"./data/processed/CRC_abundances_50.txt", row.names = FALSE)

# # after filtering, some rows still contained only zeros -> filtering them out manually
# CRC_abundances_10 <- CRC_abundances_10 %>%
#   filter(rowSums(across(where(is.numeric)))!=0)
# write.table(CRC_abundances_10,"./data/processed/CRC_abundances_10.txt", row.names = FALSE)
# 
# CRC_abundances_50 <- CRC_abundances_50 %>%
#   filter(rowSums(across(where(is.numeric)))!=0)
# write.table(CRC_abundances_50,"./data/processed/CRC_abundances_50.txt", row.names = FALSE)
```
...
write.table(CRC_abundances_10_pc,"./data/processed/CRC_abundances_10_pc.txt", row.names = FALSE)
...
write.table(CRC_abundances_50_pc,"./data/processed/CRC_abundances_50_pc.txt", row.names = FALSE)
```
